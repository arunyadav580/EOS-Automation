export default class ScoringAndRanking {
  constructor(page) {
    ...
    this.seventhTile = page.locator("//div[contains(@class, 'Accordion_accordion__gJ319')][7]");
    this.globalSearchOption = page.locator("//div[@class='search_placeholder-container__gHXbf']");
    this.termInsurance = page.locator("//button[normalize-space()='Term Insurance']");
    this.healthInsurance = page.locator("//button[normalize-space()='Health Insurance']");
    this.creditCard = page.locator("//button[normalize-space()='Credit Card']");
    this.mutualFunds = page.locator("//button[normalize-space()='Mutual Fund']");
