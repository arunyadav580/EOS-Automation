/*
Test Script Name: UpdateFinancialDetails.spec.js
Description: 
Git Link:
Prameters: 
*/
...
test.describe("test", () => {
  ...
  test('To Click on Update Financial Details', async () => {
    const memberDetailsPage = new MemberDetailsPage(page);
    await memberDetailsPage.updateFinancialDetailsButton.click();
    await page.waitForTimeout(2000);
    await expect(page).toHaveURL(baseUrl+'form/personal/'+coustomerId);
    await page.waitForTimeout(2000);
  });
});