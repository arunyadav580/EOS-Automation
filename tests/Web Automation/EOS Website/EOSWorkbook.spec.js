/*
Test Script Name: EOSWorkbook.spec.js
Description: 
Git Link:
Prameters: 
*/
...
test.describe("test", () => {
  ...
  test('To Click on Workbook', async () => {
    const memberDetailsPage = new MemberDetailsPage(page);
    await memberDetailsPage.workbookButton.click();
    await page.waitForTimeout(2000);
    await expect(page).toHaveURL(baseUrl+'workbook/details/'+coustomerId);
    await page.waitForTimeout(2000);
  });
